...
<body>
			<div class="projcard-container">
				<div class="row">
					<div class="col-md-6">
						<h1 class="section-title" style="font-size:36px;">Recent Blog</h1>
					</div>
			...
			<div class="projcard-container">
    <?php
    $query = "SELECT * FROM blog WHERE is_active = 1 ORDER BY blog_date DESC LIMIT 3"; // Assuming 'added_date' is the field representing when the blog was added
    ...
    ?>
    <a href="blog_details.php?id=<?php echo $row['id']; ?>" class="projcard-link">
        <div class="projcard projcard-customcolor" style="--projcard-color: #F5AF41;">
            <div class="projcard-innerbox">
                <img class="projcard-img" src="image/<?php echo $row['blog_image']; ?>" alt="Image" />
                <div class="projcard-textbox">
                    <div class="projcard-title"><?php echo $row['blog_name']; ?></div>
                    <div class="projcard-subtitle"><?php echo $row['blog_author']; ?></div>
                    <div class="projcard-bar"></div>
                    <div class="projcard-description"><?php echo substr($row['blog_description'], 0, 90) . '...'; ?></div>
                    <div class="projcard-tagbox">
                        <span class="projcard-tag"><?php echo $row['blog_category']; ?></span>
                        <span class="projcard-tag"><?php echo $row['blog_name']; ?></span>
                        <!-- <span class="projcard-tag"><?php echo $row['blog_date']; ?></span> -->
                    </div>
                </div>
            </div>
        </div>
