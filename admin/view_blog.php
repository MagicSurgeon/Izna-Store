...
<body>
    ...
    <div class="head">
        ...
        <div class="buttons">
            ...
            <button><a href="inactive_blogs.php">View inactive Blogs</a></button>
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<li><a class="dropdown-item" href="edit_blog.php?id=' . $row['id'] . '">Edit</a></li>';
                        echo '<li><a class="dropdown-item" href="deactivate.php?id=' . $row['id'] . '">Inactive</a></li>';
                        echo '</ul>';
                        echo '</div>';
                        echo '</td>';
                        echo '</tr>';
